...
3. Applying Migrations
   ...
   **NOTE**: Before proceeding, please go to image_gallery/website/migrations/ and delete any files or folders other than the \\_\\_init\\_\\_.py (**atention**: the \\_\\_init\\_\\_.py file MUST remain there).
